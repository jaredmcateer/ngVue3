import { b as getDefaultExportFromCjs, r as reactive, e as createApp, f as onMounted, h, i as resolveDirective, w as withDirectives, j as ref } from "./runtime-dom.esm-bundler-CLacj4Wi.js";
var angular$2 = {};
/**
 ...
 * License: MIT
 */
var hasRequiredAngular$1;
function requireAngular$1() {
  if (hasRequiredAngular$1) return angular$2;
  hasRequiredAngular$1 = 1;
  (function(window2) {
    var minErrConfig = {
      objectMaxDepth: 5,
    ...
    function copy(source, destination, maxDepth) {
      ...
      function copyType(source2) {
        switch (toString.call(source2)) {
          ...
          case "[object RegExp]":
            var re2 = new RegExp(source2.source, source2.toString().match(/[^/]*$/)[0]);
    ...
    function mergeClasses(a2, b2) {
      if (!a2 && !b2) return "";
      if (!a2) return b2;
      if (!b2) return a2;
      if (isArray(a2)) a2 = a2.join(" ");
      if (isArray(b2)) b2 = b2.join(" ");
      return a2 + " " + b2;
    }
      ...
      this.$get = [
        ...
        function($injector, $interpolate, $exceptionHandler, $templateRequest, $parse, $controller, $rootScope, $sce, $animate) {
          ...
          function byPriority(a2, b2) {
            var diff = b2.priority - a2.priority;
            if (diff !== 0) return diff;
            if (a2.name !== b2.name) return a2.name < b2.name ? -1 : 1;
      ...
      outer:
        for (var i = 0; i < tokens1.length; i++) {
          ...
          for (var j2 = 0; j2 < tokens2.length; j2++) {
            if (token === tokens2[j2]) continue outer;
          }
      ...
      this.$get = ["$injector", function($injector) {
        return function $controller(expression, locals, later, ident) {
          ...
          if (isString(expression)) {
            ...
            expression = controllers.hasOwnProperty(constructor) ? controllers[constructor] : getter(locals.$scope, constructor);
            if (!expression) {
              throw $controllerMinErr(
                "ctrlreg",
    ...
    function $LocationProvider() {
      ...
      this.$get = [
        ...
        function($rootScope, $browser, $sniffer, $rootElement, $window) {
          ...
          function urlsEqual(a2, b2) {
            return a2 === b2 || urlResolve(a2).href === urlResolve(b2).href;
          }
    ...
    function markQExceptionHandled(q2) {
      if (q2.$$state) {
        markQStateExceptionHandled(q2.$$state);
      }
    }
...
var angularExports = requireAngular();
const angular$1 = /* @__PURE__ */ getDefaultExportFromCjs(angularExports);
var D = Object.defineProperty;
var N = (e, n, t) => n in e ? D(e, n, { enumerable: true, configurable: true, writable: true, value: t }) : e[n] = t;
var a = (e, n, t) => N(e, typeof n != "symbol" ? n + "" : n, t);
function I(e, n) {
  return e && angular$1.isObject(e) ? Object.keys(e).reduce((r, i) => {
    const s = n.$eval(e[i]);
    return angular$1.isFunction(s) ? r[i] = function() {
      return n.$evalAsync(() => s.apply(null, arguments));
    } : (r[i] = s, console.warn(`[ngVue] Bound a non-function as an event handler (${i})`)), r;
  }, {}) : {};
}
function O(e, n) {
  return e ? Object.keys(e).reduce((r, i) => (i === "__ngvue_props__" ? Object.assign(r, n.$eval(e.__ngvue_props__)) : r[i] = n.$eval(e[i]), r), {}) : {};
}
function S(e) {
...
const L = {
  Object: (e) => [e],
  Array: (e) => e,
  String: (e) => e.split(/\s*,\s*/g).filter(Boolean).map((n) => ({ name: n }))
};
function R(e, n) {
  if (!e)
    return [];
  const t = n.$eval(e), r = L[S(t)];
  return r ? r(t) : [];
}
const x = ["class", "style"];
function T(e, n) {
  return x.reduce((t, r) => (t[r] = e[r] || "", n(r), t), {});
}
const z = [
  "vProps",
  "vOn",
  ...
  "ng",
  ...x
], F = new RegExp(`^(${z.join("|")})`, "i");
function B(e) {
  return Object.keys(e).filter((n) => {
    const t = F.test(n), r = n[0] === "$";
    return !(t || r);
  });
}
function G([e, ...n]) {
  return e.toLowerCase() + n.join("");
}
const C = {
  vProps: "",
  vOn: "on"
...
function V(e, n, t) {
  ...
  if (W(e)) {
    i = b[e];
    const c = n[i];
    c !== void 0 && (o.__ngvue_props__ = c, t(i));
    const u = new RegExp(`^${i}.+`, "i");
    r = Object.keys(n).filter((p) => u.test(p)), s = (p, f) => {
      const v = U(f, i);
      return v && (p[v] = n[f], t(f)), p;
    };
  } else
    r = B(n), s = (c, u) => {
      const p = n.$attr[u];
      return c[p] = n[u] === "" ? `${u}` : n[u], t(u), c;
    };
  return r.reduce(s, o);
}
function J(e, n) {
...
function w(e, n, t, r = { depth: "reference" }) {
  if (!e)
    return;
  const i = X(e, n);
  switch (r.depth) {
    case "value":
      i((s, o) => t.$watch(s, o, true));
      break;
    case "collection":
      i((s, o) => t.$watchCollection(s, o));
      break;
    case "reference":
    default:
      i((s, o) => t.$watch(s, o));
...
function Q(e, n) {
  return e === "__ngvue_props__" && angular$1.isObject(n);
}
function X(e, n) {
  return (t) => {
    Object.keys(e).forEach((r) => {
      const i = (s) => {
        Q(r, s) ? Object.keys(s).forEach((o) => {
          n[o] = s[o];
        }) : n[r] = s;
      };
      t(e[r], i);
...
function q(e) {
  let n = "AnonymousComponent";
  return e.name ? n = e.name : e.__file && (n = K(e.__file) || n), n;
}
function K(e) {
  let n = "";
  const t = e.match(/([^/\\]+)\.\w+$/);
  return t && (n = t[1].replace(/(?:^|[-_])(\w)/g, (r) => r.toUpperCase()).replace(/[-_]/g, "")), n;
}
function ee(e, n, t, r, i) {
  const s = Symbol("ngVueInstanceKey"), o = Y(s), l = ie(n, t), c = J(t, l), u = I(c.events, r), p = R(t.vDirectives, r);
  Object.assign(o.props, O(c.props, r)), Object.assign(o.attrs, O(c.attrs, r)), Object.assign(o.special, T(t, l));
  const f = { depth: t.watchDepth };
  l("watchDepth"), w(c.props, o.props, r, f), w(c.attrs, o.attrs, r, f);
  let v = re(n[0]), h2 = ne(e, v, o, u, p);
  te(h2, i), h2.mount(n[0]), r.$on("$destroy", () => {
    h2.unmount(), h2._container && angular$1.element(h2._container).remove(), h2 = null, Z(s);
  });
}
  ...
  return createApp({
    ...
    setup() {
      ...
      return onMounted(() => {
        ...
        if (n)
          try {
            (l = (o = s.value) == null ? void 0 : o.parentElement) == null || l.replaceChild(n, s.value);
          } catch {
        ...
        let o = h(e, { ...t.props, ...t.attrs, ...t.special, ...r }, () => [h("span", { ref: s })]);
        if (i.length > 0) {
          const l = i.filter((c) => !!resolveDirective(c.name)).map((c) => [resolveDirective(c.name), c.value, c.arg, c.modifiers]);
...
function te(e, n) {
  const t = n.has("$ngVue") ? n.get("$ngVue") : null;
  t && (t.initNgVuePlugins(e), t.getVuePlugins().forEach((r) => e.use(r)), t.getInjectables().forEach(([r, i]) => e.provide(r, i)), Object.entries(t.getVueDirectives()).forEach(([r, i]) => e.directive(r, i)), Object.entries(t.getVueComponents()).forEach(([r, i]) => e.component(r, i)));
}
function re(e) {
  if (e.innerHTML.trim()) {
    let n;
    if (e.children.length === 0) {
      ...
      t.innerHTML = e.innerHTML.trim(), n = t;
    } else
      n = e.children[0];
    return n;
  }
...
class A {
  constructor(n) {
    ...
    a(this, "pluginConfig", {});
    a(this, "injectables", []);
    a(this, "nativeVuePlugins", []);
    a(this, "nativeVueDirectives", {});
    a(this, "nativeVueComponents", {});
    this.$injector = n, this.$get = [
      "$injector",
      (t) => ({
        initNgVuePlugins: (i) => {
          const s = (o) => {
   ...
   */
  installNgVuePlugin(n) {
    const { $name: t, $config: r, $plugin: i } = n();
    this.pluginHooks.push(i), this.pluginConfig[t] = r;
  }
  callHooks(n, t) {
    n && n.forEach((r) => t(r));
  }
...
let j;
function le() {
  return j || (j = angular$1.module("ngVue", []).factory("createVueComponent", P)), j.name;
}
export {
  angular$1 as a,
  le as l,
